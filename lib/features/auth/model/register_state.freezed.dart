...
class _$RegisterStateImpl extends _RegisterState {
  ...
  @override
  String toString() {
    return 'RegisterState(name: $name, email: $email, phone: $phone, gender: $gender, dob: $dob, country: $country, state: $state, city: $city, isLoading: $isLoading, errorMessage: $errorMessage)';
  }
